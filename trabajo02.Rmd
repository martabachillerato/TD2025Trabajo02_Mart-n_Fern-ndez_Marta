...
matriz.criterios=multicriterio.crea.matrizvaloraciones(c(1, 3, 2, 2, 2, 5, 4, 3, 1/3, 1, 1/3, 1/2, 2, 2, 2, 1/2, 1/2, 3, 1, 1/2, 2, 4, 2, 3, 1/2, 2, 2, 1, 3, 4, 2, 2, 1/2, 1/2, 1/2, 1/3, 1, 2, 2, 3, 1/5, 1/2, 1/4, 1/4, 1/2, 1, 1/3, 1/3, 1/4, 1/2, 1/2, 1/2, 1/2, 3, 1, 3, 1/3, 2, 1/3, 1/2, 1/3, 3, 1/3, 1),numalternativas = 8,v.nombres.alternativas = c("Salario", "Beneficios", "Cercanía", "Estrés", "Desarrollo", "Relación_Estudios", "Satisfacción", "Relaciones"))

matriz.costo=multicriterio.crea.matrizvaloraciones(c(1,1/3,6,3,1,8,1/6,1/8,1),numalternativas = 3,v.nombres.alternativas = c("Alt.A","Alt.B","Alt.C"))

matriz.confiabilidad=multicriterio.crea.matrizvaloraciones(c(1,6,2,1/6,1,1/3,1/2,3,1),numalternativas = 3,v.nombres.alternativas = c("Alt.A","Alt.B","Alt.C"))

matriz.plazo_entrega=multicriterio.crea.matrizvaloraciones(c(1,8,1,1/8,1,1/8,1,8,1),numalternativas = 3,v.nombres.alternativas = c("Alt.A","Alt.B","Alt.C"))

num.alt6=3

num.cri6=3

matriznivel2_6=array(NA,dim=c(num.alt6,num.alt6,num.cri6))

matriznivel2_6[,,1] = matriz.costo

matriznivel2_6[,,2] = matriz.confiabilidad

matriznivel2_6[,,3] = matriz.plazo_entrega

solucion_metodo2_6 = multicriterio.metodoAHP.variante3.completo(matriz.criterios6,matriznivel2_6)

solucion_metodo2_6$pesos.globales

```

La mejor alternativa volvemos a comprobar que es la 2, con un peso global mayor.
52.1%